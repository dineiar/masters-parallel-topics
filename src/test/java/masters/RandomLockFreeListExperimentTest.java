...
import masters.experiment.RandomLockFreeListExperiment;

/**
 * Unit test for simple App.
 */
public class RandomLockFreeListExperimentTest
{

    public static void main(String[] args) {
        new RandomLockFreeListExperimentTest().mainTest();
    }
    ...
    {
        RandomLockFreeListExperiment experiment = new RandomLockFreeListExperiment();
